...
import { Search, Eye, X, FileText, CheckCircle2, Sparkles, Copy, Check, ShieldCheck, Clock } from "lucide-react";
...
export default function PastAssignmentsTable({ assignments }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Mobile Responsive Cards View (visible only on mobile) */}
      <div className="md:hidden space-y-3">
        {filteredAssignments.length > 0 ? (
          ...
          <div className="p-8 text-center text-zinc-500 font-mono text-xs rounded-2xl border border-zinc-800 bg-zinc-950">
      ...
      {selectedAssignment && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4 animate-in fade-in">
          <div className="w-full max-w-4xl max-h-[90vh] flex flex-col rounded-3xl border border-zinc-800 bg-zinc-950 text-white shadow-2xl overflow-hidden">
            ...
            <div className="p-6 overflow-y-auto space-y-4 flex-1">
              ...
              {activeTabInModal === "submissions" && (
                <div className="space-y-3">
                  ...
                  <div className="divide-y divide-zinc-800 rounded-2xl border border-zinc-800 bg-black">
                    {selectedAssignment.submissions > 0 ? (
                      [
                        ...
                        <div key={i} className="flex items-center justify-between p-4 text-xs font-mono">
                          ...
                          <span className="flex items-center gap-1 text-white font-bold text-xs bg-zinc-900 px-3 py-1 rounded-full border border-zinc-700">
